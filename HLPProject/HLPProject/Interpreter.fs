...
module Interpreter =
    ...
    let rec interpret state instr =
        ...
        | Some(Branch(_)) -> Err("Unresolved branch - this should have been resolved in the parser.")
        | Some(End(_)) -> Err("Unresolved termination - this should have been resolved in the parser.")
